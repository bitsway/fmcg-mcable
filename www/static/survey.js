						 ...
						 success: function(result) {
								...
								if (result==''){					
									...
									if (resultArray[0]=='FAILED'){						
										...
										//image upload function	 (not used)								
...
function prifileInfoNext(){	
	...
	if(cp_id=='' || cp_name=='' || cp_marketid==''|| cp_contact1=='' || districtThana=='' || districtThana==undefined || cp_owner_name=='' || cp_trade_license=='' || cp_vat_registration=='' || cp_Category=='' || cp_shop_rent_own=='' || cp_status==''){
